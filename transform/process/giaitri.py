...
load_dotenv()
logger = get_logger(logs_dir='/var/log/supervisor/giaitri/', log_filename='giaitri.log')
MONGO_DB = os.getenv("MONGO_DB")
MONGO_COLLECTION = os.getenv("MONGO_GT_COLLECTION")
